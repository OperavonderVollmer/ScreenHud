...
import ControlAlarmNew from "./subcomponent/ControlAlarmNew.jsx";
  ...
  return (
    ...
    >
      ...
      <div className="OPRControlRack? flex flex-row w-screen overflow-hidden p-5 gap-x-5">
        ...
        <div className="baseColor OPRControl flex flex-col overflow-auto scrollbar-hide flex-1 box-border max-w-full">
          {/* <div>
            <ControlInfo
              infoIcon={
                <>
